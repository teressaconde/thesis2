...
# FIX 2: Read uploaded_audio_data once at the top level so all blocks see the same value
...
# FIX 3: st.switch_page must be called outside any column context to work correctly
